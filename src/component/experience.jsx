...
const experiences = [
  ...
  },
  {
    ...
    role: "Frontend Developer",
    period: "2022 - 2024",
    description: "Developed and maintained scalable web applications using React, Redux, and REST APIs. Collaborated with backend teams and delivered features for e-commerce and news platforms.",
  ...
  },
  {
    ...
    role: "Web Developer",
    period: "2021 - 2022",
    description: "Built responsive websites and dashboards for local clients. Specialized in React, Firebase, and modern JavaScript frameworks.",
    ...
    <div className="experience-container">
      <div className="experience-scroll-wrapper">
        <div className="experience-section">
          <h2><span className="tw-text-white">// experience</span></h2>
          {experiences.map((exp, idx) => (
            <div key={idx} className="experience-item">
              ...
              <p className="description tw-text-[#607B96]">{exp.description}</p>
      ...
      <div className="experience-code-snippet">
        <pre>
          <code>
            <span className="tw-text-[#607B96]"><span className="line-number">1</span>// experience.js</span>
            <br />
