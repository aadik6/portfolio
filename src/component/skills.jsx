        ...
        <div className="skills-container">
          <div className="skills-scroll-wrapper">
            <div className="skills-section">
              <h2>
                <span className="tw-text-white">// skills</span>
              </h2>
              ...
              {skillCategories.map((category, index) => (
                <div className="skill-category" key={index}>
                  <h3 className="category-title">
                    <i
                      className={`ri-code-${
                        index === 0 ? "s-slash" : index === 1 ? "box" : "line"
                      }-fill tw-text-[#43D9AD] tw-mr-2`}
                    ></i>
                    ...
                    {category.skills.map((skill, skillIndex) => (
                      <div className="skill-item" key={skillIndex}>
                        <div className="skill-header tw-bg-[#011221]">
                          <span className="skill-name tw-text-[#607B96]">
                            {skill.name}
                          </span>
                          <span className="skill-level tw-text-[#607B96]">
                            {skill.level}%
                          </span>
                        </div>
            ...
            <pre>
              <code>
                <p className="tw-text-[#607B96]">
                  <span className="line-number">1</span>// skills.js
                </p>
                <div>
                ...
                <div>
                  ...
                  <span className="property">comfortable</span>: [
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="property">familiar</span>: [
