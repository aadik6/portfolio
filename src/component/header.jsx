            ...
            <div className={`mobile ${isMenuOpen ? 'open' : 'closed'}`}>
                <div className="mobile-nav">
                    <ul className='tw-flex tw-justify-between'>
                        <li>Aadarsh Kushwaha</li>
                        {isMenuOpen ?
                            <li className='icon' onClick={toogleIcon}><i class="ri-close-fill footer-icon mobile-nav-icon"></i></li> :
                            <li className='icon' onClick={toogleIcon}><i class="ri-menu-line footer-icon mobile-nav-icon"></i></li>
                        }
                    </ul>
                    <hr className='def-hr' />
                    {isMenuOpen &&
                        <>
                            <div className="mobile-nav-menu">
                                <ul className='tw-flex tw-flex-col tw-text-center'>
                                    <li onClick={toogleIcon}><NavLink to="/">_hello</NavLink></li>
                                    <hr className='def-hr' />
