        ...
        <div className="education-container">
          <div className="education-scroll-wrapper">
            <div className="education-section">
              <h2>
                <span className="tw-text-white">// education</span>
              </h2>
              ...
              <div className="education-item">
                <div className="education-header">
                  ...
                  <h3 className="institution tw-text-white">
                    Tribhuvan University
                  </h3>
                  <span className="degree tw-text-[#43D9AD]">
                    Bachelor in Computer Application
                  </span>
                </div>
                <p className="description tw-text-[#607B96]">
                  pursuing a four-year degree program with focus on programming,
                  data structures, algorithms, database systems, and software
              ...
              <div className="education-item">
                ...
                <p className="description tw-text-[#607B96]">
                  Completed two years of higher secondary education with
                  concentration on Physics, Chemistry, Mathematics and Computer
                  Science.
                </p>
                <div className="skills">
              ...
              <div className="education-item">
                <div className="education-header">
                  ...
                  <h3 className="institution tw-text-white">
                    Shree Nepal Secondry School Khajani
                  </h3>
                  <span className="degree tw-text-[#43D9AD]">
                ...
                <p className="description tw-text-[#607B96]">
                  ...
                  establishing a strong foundation in mathematics, science, and
                  computer literacy.
                </p>
                <div className="skills">
                  <span className="skill-tag">Mathematics</span>
            ...
            <pre>
              <code>
                <p className="tw-text-[#607B96]">
                  <span className="line-number">1</span>// education.js
                </p>
                <div>
                ...
                <div>
                  ...
                  <span className="string">'Tribhuvan University'</span>,
                </div>
                <div>
                  <span className="line-number">5</span>{" "}
                  <span className="property">degree</span>:{" "}
                  <span className="string">'BCA'</span>,
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="property">highSchool</span>: {"{"}
                </div>
                <div>
                  <span className="line-number">9</span>{" "}
                  <span className="property">name</span>:{" "}
                  <span className="string">'MMC-Hetauda'</span>,
                </div>
                <div>
                  <span className="line-number">10</span>{" "}
                  <span className="property">program</span>:{" "}
                  <span className="string">'Higher Secondary'</span>,
                </div>
                <div>
